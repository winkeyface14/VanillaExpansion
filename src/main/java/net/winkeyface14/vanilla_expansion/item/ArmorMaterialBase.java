...
public class ArmorMaterialBase {
    ...
    public static final ResourceKey<EquipmentAsset> ARMADILLO_SCUTE_PLAYER_KEY = ResourceKey.create(REGISTRY_KEY, Identifier.fromNamespaceAndPath(VanillaExpansion.MOD_ID, "armadillo_scute"));
    ...
    public static final ArmorMaterial ARMADILLO_SCUTE_PLAYER_ARMOR_MATERIAL = new ArmorMaterial(14, ArmorMaterials.makeDefense(2, 5, 	6, 2, 5),9, SoundEvents.ARMOR_EQUIP_LEATHER,0.5f,0.0f, TagRegHandler.Items.ARMADILLO_SCUTE_REPAIR, ARMADILLO_SCUTE_PLAYER_KEY);


    public static final ArmorMaterial REINFORCED_LEATHER_ARMOR_MATERIAL = new ArmorMaterial(12, ArmorMaterials.makeDefense(1, 2, 3, 1,5),12, SoundEvents.ARMOR_EQUIP_IRON,0.5f,0, TagRegHandler.Items.REINFORCED_LEATHER_REPAIR, REINFORCED_LEATHER_KEY);
