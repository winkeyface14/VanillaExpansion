...
public class ItemRegHandler {
    ...
    public static final Item LAPIS_LAZULI_SWORD_BLADE = registerItem("lapis_lazuli_sword_blade", Item::new);
    public static final Item LAPIS_LAZULI_SPEAR_TIP = registerItem("lapis_lazuli_spear_tip", Item::new);
    public static final Item LAPIS_LAZULI_PICKAXE_HEAD = registerItem("lapis_lazuli_pickaxe_head", Item::new);
    public static final Item LAPIS_LAZULI_AXE_HEAD = registerItem("lapis_lazuli_axe_head", Item::new);
    public static final Item LAPIS_LAZULI_SHOVEL_HEAD = registerItem("lapis_lazuli_shovel_head", Item::new);
    public static final Item LAPIS_LAZULI_HOE_HEAD = registerItem("lapis_lazuli_hoe_head", Item::new);
    ...
    public static final Item BURNT_QUARTZ_SWORD_BLADE = registerItem("burnt_quartz_sword_blade", Item::new);
    public static final Item BURNT_QUARTZ_SPEAR_TIP = registerItem("burnt_quartz_spear_tip", Item::new);
    public static final Item BURNT_QUARTZ_PICKAXE_HEAD = registerItem("burnt_quartz_pickaxe_head", Item::new);
    public static final Item BURNT_QUARTZ_AXE_HEAD = registerItem("burnt_quartz_axe_head", Item::new);
    public static final Item BURNT_QUARTZ_SHOVEL_HEAD = registerItem("burnt_quartz_shovel_head", Item::new);
    public static final Item BURNT_QUARTZ_HOE_HEAD = registerItem("burnt_quartz_hoe_head", Item::new);
